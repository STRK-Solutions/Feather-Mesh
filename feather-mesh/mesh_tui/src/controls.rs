...
pub const HELP: &str = "Keyboard: Tab menus; / search; PgUp/PgDn scroll; g start/stop guide; x skip guide lesson; q exit. Catalog: Up/Down or j/k select; Enter details; e examples; p bounded table metadata preview; [ ] pages. Lineage: Up/Down or j/k selects the version shown in its version lineage. Hosted Assistant: a compose; Up/Down or j/k scroll; PgUp/PgDn page; s stop; output remains available in the Assistant menu. Guided mode uses the same assistant conversation and usage ledger, advertises no tools, and shows a read-only Guide projection on every tab. Product views need 120 columns for the guided three-pane layout.\nCommands (quote paths with spaces):\n:init NAMESPACE [SERVING_DIR]\n:project \"ROOT\"\n:resolve REF VERSION\n:filter '{\"owner_team\":\"Climate\",\"limit\":25}'\n:publish \"DRAFT.json\" (I/O consent then full review)\n:draft new table|raster\n:draft load \"DRAFT.json\"\n:draft set /description '\"Known scientific facts\"'\n:draft set /assets '[{\"id\":\"data\",\"path\":\"relative/file.parquet\",\"role\":\"data\",\"media_type\":\"application/vnd.apache.parquet\"}]'\n:draft validate\n:draft save NAME.json [--overwrite]\n:export NAME.txt [--overwrite]\n:stage REF VERSION \"DESTINATION\" [--overwrite]\n:withdraw REF VERSION REASON\n:recover\n:guide start|stop|restart|skip\n:tutorial start|stop|skip (compatibility aliases)\n:agent-profile NAME|off\n:agent-draft\n:integrity-consent REF VERSION\n:usage\n\nDrafts/exports stay in .feam/drafts or .feam/exports. Metadata editing never invents missing scientific/policy facts. Source assets are explicitly selected under the serving root. Full hashing needs local consent. Copies finish before normal shutdown. Forced loss requires reconciliation. Project/profile changes clear the shared transcript, guide state, handles, reviews, and confirmations.\nHosted: a compose; s stop; local profile context policy controls disclosure. No shell/Python execution tools.";
